...
class ProductsController extends Controller
{
    ...
    public function update_products($product_id , Request $request){
        ...
        $data->pro_details->speci_os = $request->screen;
    ...
    public function reply_comment(Request $request){
        ...
        $comment->comment_name = 'HKTMobileStore';
        $comment->save();
    ...
    public function load_comment(Request $request){
        ...
        foreach($comment as $comm){
            ...
            <div class="row style_comment">
                                        ...
                                        <div class="col-md-2">
                                            <img width="100%" src="'.url('/frontend/images/batman.png').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
