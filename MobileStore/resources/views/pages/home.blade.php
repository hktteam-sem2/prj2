                    ...
                    <div class="single-products">
                            <div class="productinfo text-center">
                                <form>
                                   ...
                                   <input type="button" value="Thêm giỏ hàng" class="btn btn-default add-to-cart" data-id_product="{{$allpro->product_id}}" name="add-to-cart">


                                   <input type="button" data-toggle="modal" data-target="#xemnhanh"  value="Xem nhanh" class="btn btn-default xemnhanh" data-id_product="{{$allpro->product_id}}" name="add-to-cart">
                                </form>
                            </div>
                    </div>
                    <div class="choose">
